...
layout: page
title: Veikla
description: Profesionalios teisinės paslaugos verslui — bendrovių teisė, sutarčių rengimas, mokesčių konsultacijos ir daugiau.
---
...
- [Bendrovių teisė](#imoniu-teise)
- [Sutarčių teisė](#sutarciu-rengimas)
- [Nekilnojamojo turto teisė](#nekilnojamojo-turto-teise)
- [Darbo teisė](#darbo-teise)
- [Mokesčių teisė](#mokesciu-isaiskinimas)
- [Asmens duomenų apsauga](#asmens-duomenu-apsauga)
- [Intelektinės nuosavybės teisė](#intelektines-nuosavybes-teise)
- [Viešieji pirkimai](#viesieji-pirkimai)
- [Finansų teisė](#finansu-teise)

## Bendrovių teisė {#imoniu-teise}

- įmonių veiklos dokumentų (įstatų, akcininkų, valdybos sprendimų ir pan.) rengimas;
- įmonių pertvarkymo, reorganizavimo, likvidavimo, susijungimų, įsigijimų, filialų ir atstovybių veiklos pradžios ir nutraukimo dokumentų projektų rengimas, atstovavimas juos derinant bei registruojant;
...
- konsultacijos ir praktinė pagalba vidaus tvarkos taisyklių, pareiginių nuostatų ir kitų dokumentų parengimo klausimais.
